...
#define DEFAULT_INPUT_PRIMARY "lena.bmp"
#define DEFAULT_INPUT_FALLBACK NULL
#define DEFAULT_SERIAL_OUTPUT "lena_color_serial.bmp"
#define DEFAULT_PARALLEL_OUTPUT "lena_color_parallel.bmp"
...
int main(int argc, char **argv)
{
    ...
    if (argc == 1)
    {
        ...
        {
            fprintf(stderr, "Failed to open default input file: %s\n", DEFAULT_INPUT_PRIMARY);
            return 1;
        }
    }
    else
